    ...
    <div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(310px, 1fr))", gap: 16 }}>
        ...
        <Card icon="🤖" name="Anthropic (Claude)" data={an}>
          ...
          <div style={{ marginTop: 10, background: T.yellowBg, border: `1px solid ${T.yellowBd}`, borderRadius: 8, padding: "8px 12px", fontSize: 11.5, color: "#92400e", lineHeight: 1.5 }}>
            For token usage, spend, and credit balance check{" "}
            <a href="https://console.anthropic.com" target="_blank" rel="noreferrer" style={{ color: "#92400e", fontWeight: 700 }}>console.anthropic.com</a>
          </div>
        </Card>
