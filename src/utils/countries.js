...
// Each entry: { name, code (ISO 3166-1), currency (ISO 4217), currencySymbol }
const COUNTRIES = [
  ...
  { name: "Congo (DRC)", code: "CD", currency: "CDF", currencySymbol: "FC" },
  { name: "Congo (Republic)", code: "CG", currency: "XAF", currencySymbol: "FCFA" },
  ...
  { name: "East Timor", code: "TL", currency: "USD", currencySymbol: "$" },
  ...
  { name: "Eswatini", code: "SZ", currency: "SZL", currencySymbol: "E" },
  { name: "Ethiopia", code: "ET", currency: "ETB", currencySymbol: "Br" },
  { name: "Fiji", code: "FJ", currency: "FJD", currencySymbol: "FJ$" },
  ...
  { name: "Ivory Coast", code: "CI", currency: "XOF", currencySymbol: "CFA" },
  ...
  { name: "Kiribati", code: "KI", currency: "AUD", currencySymbol: "A$" },
  { name: "Kosovo", code: "XK", currency: "EUR", currencySymbol: "€" },
  { name: "Kuwait", code: "KW", currency: "KWD", currencySymbol: "د.ك" },
  { name: "Kyrgyzstan", code: "KG", currency: "KGS", currencySymbol: "сом" },
  { name: "Laos", code: "LA", currency: "LAK", currencySymbol: "₭" },
  { name: "Latvia", code: "LV", currency: "EUR", currencySymbol: "€" },
  { name: "Lebanon", code: "LB", currency: "LBP", currencySymbol: "L£" },
  ...
  { name: "Nauru", code: "NR", currency: "AUD", currencySymbol: "A$" },
  ...
  { name: "Palestine", code: "PS", currency: "ILS", currencySymbol: "₪" },
  ...
  { name: "São Tomé and Príncipe", code: "ST", currency: "STN", currencySymbol: "Db" },
  { name: "Saudi Arabia", code: "SA", currency: "SAR", currencySymbol: "ر.س" },
  { name: "Senegal", code: "SN", currency: "XOF", currencySymbol: "CFA" },
  { name: "Serbia", code: "RS", currency: "RSD", currencySymbol: "din." },
  { name: "Seychelles", code: "SC", currency: "SCR", currencySymbol: "₨" },
  { name: "Sierra Leone", code: "SL", currency: "SLE", currencySymbol: "Le" },
  ...
  { name: "Solomon Islands", code: "SB", currency: "SBD", currencySymbol: "SI$" },
  ...
  { name: "Tuvalu", code: "TV", currency: "AUD", currencySymbol: "A$" },
...
// Helper: get currency symbol from ISO 4217 currency code (e.g. "GBP" → "£")
...
// Helper: get country flag emoji from 2-letter code
